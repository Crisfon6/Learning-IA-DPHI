...
"resource": {
  ...
  "rules":[
    ...
    [["if",6,54,153],["add",103]],
    [["if",6,76,154],["add",104]],
    [["if",6,155,156],["add",105]],
    [["if",6,157,158],["add",106]],
    [["if",6,158,159],["add",106]],
    [["if",6,160,161],["add",107]],
    [["if",6,161,162],["add",107]],
    [["if",6,163,164],["add",108]],
    [["if",6,165],["add",109]],
    [["if",6,166],["add",109]],
    [["if",6,167,168],["add",110]],
    [["if",6,168,169],["add",110]],
    [["if",6,76,170],["add",111]],
    [["if",6,54,171],["add",112]],
    [["if",6,58,172],["add",113]],
    [["if",6,58,173],["add",114]],
    [["if",6,174,175],["add",115]],
    [["if",6,176,177],["add",116]],
    [["if",6,178,179],["add",117]],
    [["if",6,180,181],["add",118]],
    [["if",6,182,183],["add",119]],
    [["if",6,184,185],["add",120]],
    [["if",6,186,187],["add",121]],
    [["if",6,188,189],["add",122]],
    [["if",6,190,191],["add",123]],
    [["if",6,192,193],["add",124]],
    [["if",6,194,195],["add",125]],
    [["if",6,196],["add",126]],
    [["if",6,197],["add",127]],
    [["if",6,198],["add",128]],
    [["if",6,199,200,201],["add",129]],
    [["if",6,11,200,202],["add",129]],
    [["if",6,199,201,203],["add",130]],
    [["if",6,199,203,204],["add",130]],
    [["if",6,205],["add",131]],
    [["if",6,76,206],["add",132]],
    [["if",6,207],["add",133]],
    [["if",6,54,208],["add",134]],
    [["if",6,209,210],["add",135]],
    [["if",6,210,211],["add",136]],
    [["if",6,212,213],["add",137]],
    [["if",6,214,215],["add",138]],
    [["if",6,216,217],["add",139]],
    [["if",6,218,219],["add",140]],
    [["if",6,58,220],["add",141]],
    [["if",6,58,215],["add",142]],
    [["if",6,58,217],["add",143]],
    [["if",6,58,219],["add",144]],
...
return null},Zc=!1;if(F.querySelectorAll)try{var $c=F.querySelectorAll(":root");$c&&1==$c.length&&$c[0]==F.documentElement&&(Zc=!0)}catch(a){}var Wc=Zc;var K={},od=null,pd=Math.random();K.s="GTM-MPSM42V";K.Ob="6h1";K.Ld="";var qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},rd="googletagmanager.com/gtm.js";
var sd=rd,td=null,ud=null,vd=null,wd="//www.googletagmanager.com/a?id="+K.s+"&cv=99",xd={},yd={},zd=function(){var a=od.sequence||0;od.sequence=a+1;return a};
...
b);return E[a]},Ok=function(a,b,c){return ue(a,b,void 0===c?!0:!!c)},Pk=function(a,b){if(eg()){b&&G(b)}else nc(a,b)},Qk=function(a){return!!ek(a,"init",!1)},Rk=function(a){ck(a,"init",!0)},Sk=function(a,b){var c=(void 0===b?0:b)?"googletagmanager.com/gtag/js":sd;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";T(S("https://","http://",c))},Tk=function(a,b){var c=a[b];return c};
